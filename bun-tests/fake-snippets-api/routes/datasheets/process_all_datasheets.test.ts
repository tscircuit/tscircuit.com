...
test("process datasheets", async () => {
  ...
  expect(res.data.datasheet.description).not.toBeNull()
  expect(res.data.datasheet.summary).not.toBeNull()
  expect(res.data.datasheet.chip_type).not.toBeNull()
  expect(res.data.datasheet.footprint_information).not.toBeNull()
  expect(res.data.datasheet.metadata).not.toBeNull()
})
