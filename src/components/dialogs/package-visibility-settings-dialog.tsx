      ...
      <DialogContent>
        ...
        <div className="py-1">
          <RadioGroup
            ...
            className="space-y-4"
          >
            <div className="flex items-start space-x-2 px-2 py-4 rounded-md hover:bg-slate-100 cursor-pointer" onClick={() => setIsPrivate(false)}>
            ...
            <div className="flex items-start space-x-2 px-2 py-4 rounded-md hover:bg-slate-100 cursor-pointer" onClick={() => setIsPrivate(true)}>
