...
export default function SidebarAboutSection({ packageInfo, isLoading = false }: SidebarAboutSectionProps) {
  ...
  return (
    <div className="mb-6">
      <h2 className="text-lg font-semibold mb-2">About</h2>
      <p className="text-sm mb-3">{packageInfo?.description || "A Default 60 keyboard created with tscircuit"}</p>
      <a href="#" className="text-blue-600 dark:text-[#58a6ff] hover:underline text-sm flex items-center mb-4">
      ...
      <div className="space-y-2 text-sm">
        <div className="flex items-center">
          <svg className="h-4 w-4 mr-2 text-gray-500 dark:text-[#8b949e]" viewBox="0 0 16 16" fill="currentColor">
