import { usePackageReleaseById, usePackageReleaseByNameAndVersion } from "./use-package-release"
...
export const usePackageReleaseByIdOrVersion = (
  ...
  const isReleaseIdUuid = releaseIdOrVersion ? isUuid(releaseIdOrVersion) : false
