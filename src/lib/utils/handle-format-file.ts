...
export function handleFormatFile({ files, currentFile, updateFileContent, toast }: { files: PackageFile[], currentFile: string | null, updateFileContent: (path: string, content: string) => void, toast: (toastData: ToasterToast) => string }) {
